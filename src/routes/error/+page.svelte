...
{#if loaded}
	<div class="absolute w-full h-full flex z-50">
		<div class="absolute rounded w-full h-full backdrop-blur flex justify-center">
			<div class="m-auto pb-44 flex flex-col justify-center">
				<div class="max-w-md">
					...
					<div class=" mt-6 mx-auto relative group w-fit">
						<button
							class="relative z-20 flex px-5 py-2 rounded-full bg-primary-med hover:bg-primary-light text-white transition font-medium text-sm"
							on:click={() => {
								location.href = '/';
							}}
						>
