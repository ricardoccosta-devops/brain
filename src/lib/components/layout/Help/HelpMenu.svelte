...
>
	...
	<div slot="content">
		...
		>
			<DropdownMenu.Item
				class="flex gap-2 items-center px-3 py-2 text-sm  cursor-pointer hover:bg-support-lightblue text-primary-med rounded-md"
				id="chat-share-button"
				on:click={() => {
					window.open('https://docs.brAIn.com', '_blank');
				}}
			>
