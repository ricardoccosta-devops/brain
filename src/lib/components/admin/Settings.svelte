...
<div class="flex flex-col lg:flex-row w-full h-full py-2 lg:space-x-4">
	<div
		class="tabs flex flex-row overflow-x-auto space-x-1 max-w-full lg:space-x-0 lg:space-y-1 lg:flex-col lg:flex-none lg:w-44  text-xs text-left scrollbar-none"
	>
		<button
