				...
				<div>
						...
						<div class="w-full bg-white border border-solid border-gray-250  rounded px-5 py-3 my-2">
							...
							<div class=" mt-2 mb-1 flex justify-end space-x-1.5 text-sm font-medium">
								<button
									...
									class="px-4 py-2 bg-white hover:bg-support-lightblue text-primary-med transition rounded"
									on:click={() => {
										cancelEditMessage();
									}}
								>
					...
					{:else}
						<div class="w-full">
							...
							{#if message.error}
								<div
									class="flex mt-2 mb-4 space-x-2 border px-4 py-3 border-red-800 bg-red-800/30 font-medium rounded"
								>
									<svg
