...
<div class=" flex w-full space-x-2">
	...
	<div>
		<a
			class=" px-2 py-2 rounded border border-gray-200 hover:bg-support-lightblue hover:text-primary-med transition font-medium text-sm flex items-center space-x-1"
